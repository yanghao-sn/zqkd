...
[task_local]
#中青看点大转盘抽奖
0 50 6 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_Rotary.js, tag=中青看点大转盘抽奖, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 50 6 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_Rotary.js,tag=中青看点大转盘抽奖

===============Surge=================
中青看点大转盘抽奖 = type=cron,cronexp="0 50 6 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_Rotary.js

============小火箭=========
中青看点大转盘抽奖 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_Rotary.js, cronexpr="0 50 6 * * *", timeout=3600, enable=true
*/
