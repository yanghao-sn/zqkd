...
[task_local]
#中青看点打卡赚钱
31 5,9 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_wakeup.js, tag=中青看点打卡赚钱, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "31 5,9 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_wakeup.js,tag=中青看点打卡赚钱

===============Surge=================
中青看点打卡赚钱 = type=cron,cronexp="31 5,9 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_wakeup.js

============小火箭=========
中青看点打卡赚钱 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_wakeup.js, cronexpr="31 5,9 * * *", timeout=3600, enable=true
*/
...
Object.keys(zq_cookies).forEach((item) => {
	...
	!(async () => {
		...
		for (let k = 0; k < zq_cookieArr.length; k++) {
			...
			zq_cookie1 = cookie_id +
				'&device_brand=xfdg&device_id=cc7dgdsgfsz83e&device_model=1gx&device_platform=android&device_type=android&inner_version=202107261526&mi=0&openudid=cc7dgdsgfsz83e&os_api=27&os_version=bdftgsdfga&phone_network=WIFI&phone_sim=1' +
				'&request_time=' + time1 + '&time=' + time1 + '&' + bodyVal
	...
	return new Promise((resolve) => {
		let url = {
			...
			headers: {
				'Host': 'kd.youth.cn',
				'Content-Length': '0',
				'Referer': ' https://kd.youth.cn/h5/20190603cardactive/?' +
					'keyword_wyq=woyaoq.com&access=4G&app-version=8.1.2&app_version=8.1.2&carrier=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8&channel=c1005&' +
					zq_cookie1
			},
		}
