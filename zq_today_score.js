...
[task_local]
#中青看点收益统计
15 23 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_today_score.js, tag=中青看点收益统计, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "15 23 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_today_score.js,tag=中青看点收益统计

===============Surge=================
中青看点收益统计 = type=cron,cronexp="15 23 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_today_score.js

============小火箭=========
中青看点收益统计 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_today_score.js, cronexpr="15 23 * * *", timeout=3600, enable=true
*/
